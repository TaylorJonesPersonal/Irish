...
export const CartTabBar = ({navigation, route}:any) => {
    const basketBadgeNumber = useSelector<any, any>((state) => state.checkoutBasketBadge.checkoutBasketBadge);
    return(
        <Tab.Navigator initialRouteName='Basket' screenOptions={{ headerShown: false, tabBarStyle: { position: 'absolute', backgroundColor: 'white', borderRadius: 5, opacity: .95 }, tabBarShowLabel: false }}>
